...
import calculateintersectpoint
shots_fired = 0
shots_successful = 0
accuracy = 0
GAME__SPEED = 60
...
accuracytext = myfont.render("INDETERMINATE ACURACY", True, (255, 255, 255))
...
pygame.display.set_caption("Asteroids by Torin Stephens")
while not done:
    screen.fill((0, 0, 0))
    ...
    if explodecounter != 0:
        ...
        if dead == True:
            ...
            loserect.midtop = (SIZE/2, SIZE/2-50)
            screen.blit(lose, loserect)
            highscoretextrect = newhighscoretext.get_rect()
            highscoretextrect.midtop = (SIZE/2, SIZE/2+55)
            screen.blit(newhighscoretext, highscoretextrect)
            restartrect = restart.get_rect()
            restartrect.midtop = (SIZE/2, SIZE/2+80)
    ...
    scoretextrect.bottomright = (100, 42)
    ...
    for bullet in bullets:
        ...
        if bullet.y > SIZE or bullet.y < 0 or bullet.x > SIZE or bullet.x < 0:
            ...
            score -= 10
            scoretext = myfont.render(str(score), True, (255, 255, 255)) 
            accuracy = round((shots_successful/shots_fired)*100)
            accuracytext = myfont.render(str(accuracy)+"%", True, (255, 255, 255))
        elif mothership_on:
            if ((None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x+(15*mothership_type*MOTHERSHIP_SIZE), mothership_y), (mothership_x+(8*mothership_type*MOTHERSHIP_SIZE), mothership_y+(7*mothership_type*MOTHERSHIP_SIZE)))) or 
                (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x-(15*mothership_type*MOTHERSHIP_SIZE), mothership_y), (mothership_x-(8*mothership_type*MOTHERSHIP_SIZE), mothership_y+(7*mothership_type*MOTHERSHIP_SIZE)))) or 
                (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x+(15*mothership_type*MOTHERSHIP_SIZE), mothership_y), (mothership_x+(8*mothership_type*MOTHERSHIP_SIZE), mothership_y-(7*mothership_type*MOTHERSHIP_SIZE)))) or 
                (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x-(15*mothership_type*MOTHERSHIP_SIZE), mothership_y), (mothership_x-(8*mothership_type*MOTHERSHIP_SIZE), mothership_y-(7*mothership_type*MOTHERSHIP_SIZE)))) or 
                (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x-(8*mothership_type*MOTHERSHIP_SIZE), mothership_y+(7*mothership_type*MOTHERSHIP_SIZE)), (mothership_x+(8*mothership_type*MOTHERSHIP_SIZE), mothership_y+(7*mothership_type*MOTHERSHIP_SIZE)))) or 
                (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x-(7*mothership_type*MOTHERSHIP_SIZE), mothership_y-(7*mothership_type*MOTHERSHIP_SIZE)), (mothership_x-(7*mothership_type*MOTHERSHIP_SIZE), mothership_y-(14*mothership_type*MOTHERSHIP_SIZE)))) or 
                (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x+(7*mothership_type*MOTHERSHIP_SIZE), mothership_y-(7*mothership_type*MOTHERSHIP_SIZE)), (mothership_x+(7*mothership_type*MOTHERSHIP_SIZE), mothership_y-(14*mothership_type*MOTHERSHIP_SIZE)))) or 
                (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), (mothership_x+(7*mothership_type*MOTHERSHIP_SIZE), mothership_y-(14*mothership_type*MOTHERSHIP_SIZE)), (mothership_x-(7*mothership_type*MOTHERSHIP_SIZE), mothership_y-(14*mothership_type*MOTHERSHIP_SIZE))))):
    ...
    for asteroid in asteroids:
        ...
        for bullet in bullets:
            if math.dist((bullet.x, bullet.y), (asteroid.x, asteroid.y)) < (asteroid.Size/4*asteroid_size*20)+20:
                if ((None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), ((asteroid.x+(math.sin(math.radians(180+asteroid.angle))*10)*asteroid_size*asteroid.Size/4), (asteroid.y+(math.cos(math.radians(180+asteroid.angle))*10)*asteroid_size*asteroid.Size/4)), (((math.sin(math.radians(213+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)+asteroid.x, ((math.cos(math.radians(213+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)+asteroid.y))) or 
                    (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), ((asteroid.x+(math.sin(math.radians(213+asteroid.angle))*15)*asteroid_size*asteroid.Size/4), (asteroid.y+(math.cos(math.radians(213+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)), (((math.sin(math.radians(250+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)+asteroid.x, ((math.cos(math.radians(250+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)+asteroid.y))) or 
                    (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), ((asteroid.x+(math.sin(math.radians(250+asteroid.angle))*15)*asteroid_size*asteroid.Size/4), (asteroid.y+(math.cos(math.radians(250+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)), (((math.sin(math.radians(255+asteroid.angle))*10)*asteroid_size*asteroid.Size/4)+asteroid.x, ((math.cos(math.radians(255+asteroid.angle))*10)*asteroid_size*asteroid.Size/4)+asteroid.y))) or 
                    (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), ((asteroid.x+(math.sin(math.radians(255+asteroid.angle))*10)*asteroid_size*asteroid.Size/4), (asteroid.y+(math.cos(math.radians(255+asteroid.angle))*10)*asteroid_size*asteroid.Size/4)), (((math.sin(math.radians(300+asteroid.angle))*20)*asteroid_size*asteroid.Size/4)+asteroid.x, ((math.cos(math.radians(300+asteroid.angle))*20)*asteroid_size*asteroid.Size/4)+asteroid.y))) or 
                    (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), ((asteroid.x+(math.sin(math.radians(300+asteroid.angle))*20)*asteroid_size*asteroid.Size/4), (asteroid.y+(math.cos(math.radians(300+asteroid.angle))*20)*asteroid_size*asteroid.Size/4)), (((math.sin(math.radians(343+asteroid.angle))*20)*asteroid_size*asteroid.Size/4)+asteroid.x, ((math.cos(math.radians(343+asteroid.angle))*20)*asteroid_size*asteroid.Size/4)+asteroid.y))) or 
                    (None != calculateintersectpoint.calculateIntersectPoint((bullet.x, bullet.y), (bullet.xprev, bullet.yprev), ((asteroid.x+(math.sin(math.radians(343+asteroid.angle))*20)*asteroid_size*asteroid.Size/4), (asteroid.y+(math.cos(math.radians(343+asteroid.angle))*20)*asteroid_size*asteroid.Size/4)), (((math.sin(math.radians(17+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)+asteroid.x, ((math.cos(math.radians(17+asteroid.angle))*15)*asteroid_size*asteroid.Size/4)+asteroid.y))) or 
    ...
    for bullet in mothership_bullets:
        ...
        if ((None != calculateintersectpoint.calculateIntersectPoint((positionx + (math.sin(math.radians(angle+160))*20), positiony + (math.cos(math.radians(angle+160))*20)), (positionx + (math.sin(math.radians(angle))*20), positiony + (math.cos(math.radians(angle))*20)), (bullet.x, bullet.y), (bullet.xprev, bullet.yprev))) or 
            (None != calculateintersectpoint.calculateIntersectPoint((positionx + (math.sin(math.radians(angle+160))*20), positiony + (math.cos(math.radians(angle+160))*20)), (positionx + (math.sin(math.radians(angle))*20), positiony + (math.cos(math.radians(angle))*20)), (bullet.x, bullet.y), (bullet.xprev, bullet.yprev)))) and explode == False:
            lives -= 1
            explode = True
            explodecounter = 120
            explotion = make_explotion(positionx + (math.sin(math.radians(angle-160))*20), positiony + (math.cos(math.radians(angle-160))*20), random.randint(-300, 300)/100, random.randint(-300, 300)/100, 20+angle, 20)
    ...
    accuracytextrect.topright = (SIZE-4, 4)
